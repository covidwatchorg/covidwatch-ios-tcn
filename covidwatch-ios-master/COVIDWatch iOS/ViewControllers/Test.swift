...
class Test: UIViewController {
 var icon: UIImageView?
    ...
    override func viewDidLoad() {
        ...
        var imagea: UIImage = UIImage(named: "logo-cw (2)")!
        ...
        if step == 1 {
            ...
            UIView.animate(withDuration: 1.0,
                              delay: 1.0,
                                                                                                     options: [],
                                                                                                     animations: { [weak self] in
                                                                                                        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {                                          self!.posLbl.text = "Select Date"
                                                                               ...
                                                                               self!.posLbl.sizeToFit()
                                                                                          ...
                                                                                          self!.posLbl.fadeInL(2.6)
                                                                                                        ...
                                                                                                        DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {                        self!.q1.text = "When did your symptoms start?"
                                                                                                           self!.q1.sizeToFit()
